...
int main() {
    ...
    do {
        ...
        printf("6. Export Contacts to Text File\n");
        printf("7. Exit\n");
        printf("=============================\n");
...
void addContact() {
    ...
    // Automatically export contacts to text file
    exportContactsToTextFile();
}
...
void exportContactsToTextFile() {
    ...
    file = fopen(FILE_NAME, "rb");
    exportFile = fopen("contacts.txt", "w");

    if (file == NULL || exportFile == NULL) {
        printf("Error creating export file!\n");
        return;
    }

    fprintf(exportFile, "List of Contacts:\n");
    fprintf(exportFile, "===========================================\n");
    while (fread(&contact, sizeof(contact), 1, file)) {
        fprintf(exportFile, "Name: %s\n", contact.name);
        fprintf(exportFile, "Phone: %s\n", contact.phone);
        fprintf(exportFile, "Email: %s\n", contact.email);
        fprintf(exportFile, "Address: %s\n", contact.address);
        fprintf(exportFile, "-------------------------------------------\n");
    }
    ...
    printf("Contacts exported successfully to 'contacts.txt'.\n");
}
